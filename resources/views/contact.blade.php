                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6 col-12" style="padding-right: 15px;padding-left:15px;">
                        <div class="card card2" id="card1" style="height: 462px !important">
                           ...
                           <div class="row mt-3">
                              <div class="col-lg-3 col-4 text-left"style="font-size:1.2rem;">Phone:</div>
                              <div class="col-lg-8 col-8 pl-0">
                                 <div class="text-left"style="font-size:1.2rem;">17255577</div>
                              </div>
                           </div>
                           <div class="row mt-4">
                        ...
                        {{-- 
                        <h5>
                           Address:<span> Juffair Gables,Building No:1234,Way234,block789,
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        ...
                        <div class="section-tittle text-center mb-90">
                           <h2 class="mb-5 mt-3">Location</h2>
                           <iframe class="mt-3"
