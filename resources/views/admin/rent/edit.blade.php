        ...
        <div class="card">
          <div class="card-header">
           <h4>Rent Collection Form</h4>
            ...
            <div class="card-body">
              <form action="{{ isset($rent) ? route('rent.update', $rent->id) : '' }}" autocomplete="off" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <select name="tenant_id" class="form-control"  id="" style="height: 37px;">
                            ...
                            @foreach ($tenant_list as $tenant)
                                <option value="{{ $tenant->id }}" @if($rent->tenant_id == $tenant->id) selected @endif>{{ $tenant->tenant_first_name }} {{ $tenant->tenant_last_name }}</option>
                            @endforeach
                          </select>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" value="{{ isset($rent->rent_amount) ? round($rent->rent_amount,0) : '' }}" readonly  name="rent_amount">
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="form-group">
                          <label for="">Received Amount (BD)</label>
                          <input type="text" class="form-control" value="{{ isset($rent->received_amount) ? round($rent->received_amount,0) : '' }}" name="received_amount">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="custom-control custom-checkbox mb-3">
                        <input type="checkbox" name="monthly_checkbox"  class="monthly_checkbox custom-control-input" id="customCheck1" @if($rent->rent_month != null) checked @endif>
                        <label class="custom-control-label" for="customCheck1">Monthly base</label>
                      </div>
                    </div>
                  </div>
                  <div class="monthly-base-rent-input" @if($rent->rent_month ==null) style="display: none;" @endif>
                    <div class="row">
                      <div class="col-lg-4">
                          <div class="form-group">
                            <label for="">Rent Month</label>
                            <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                              <input type="text" value="{{ isset($rent->rent_month) ? $rent->rent_month : "" }}" name="rent_month" class="form-control datetimepicker-input" data-target="#datetimepicker1"/>
                  ...
                  <div class="period-base-rent-inputs" @if($rent->rent_month !=null) style="display: none;" @endif>
                    <div class="row">
                      <div class="col-lg-12">
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <div class="input-group date" id="datetimepicker2" data-target-input="nearest">
                                <input type="text" name="rent_start_month" value="{{ isset($rent->rent_start_month) ? $rent->rent_start_month : "" }}" class="form-control datetimepicker-input" data-target="#datetimepicker2"/>
                          ...
                          <div class="col-lg-4">
                            <div class="form-group">
                              ...
                              <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                <input type="text" name="rent_end_month" value="{{ isset($rent->rent_end_month) ? $rent->rent_end_month : "" }}" class="form-control datetimepicker-input" data-target="#datetimepicker3"/>
